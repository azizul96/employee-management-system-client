    ...
    return (
            ...
            <footer className="footer justify-between p-10  text-neutral-content container mx-auto">
                ...
                <nav>
                    ...
                    <a className="text-white text-3xl" href="https://twitter.com/home"><FaTwitter></FaTwitter></a> 
                    <a className="text-white text-3xl" href="https://www.youtube.com/"><FaYoutube></FaYoutube></a> 
                    <a className="text-white text-3xl" href="https://www.facebook.com/"><FaFacebookF></FaFacebookF></a>
                    </div>
                </nav>
